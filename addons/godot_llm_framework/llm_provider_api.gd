...
func extract_response_message(_response: Dictionary) -> Dictionary:
...
func format_tool_result(_tool_result: Dictionary) -> Dictionary:
	push_error("Method 'format_tool_result' must be overridden in derived class")
	return {}
